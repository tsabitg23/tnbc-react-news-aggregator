...
export default function Home() {
  ...
  const {data: newsApiData, error: newsApiIsError, isLoading: newsApiIsLoading} = useNewsApiGetHeadlineQuery({pageSize: newsApiPageSize, page: currentPage});
  const {data: guardianData, error: guardianError, isLoading: guardianIsLoading} = useGetGuardianContentQuery({pageSize: guardianPageSize, page: currentPage});
  const {data: nytData, error: nytError, isLoading: nytIsLoading} = useGetNYTContentQuery({pageSize: newYorkTimesPageSize, page: currentPage, section: 'all'});
